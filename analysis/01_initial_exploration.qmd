...
metadata_event_detections <- read_csv(here("data", "taiga_audio_events_metadata_5_owls.csv"))
```
...
metadata_event_detections %>%
  mutate(clip_length = fct_rev(factor(clip_length))) %>%
  ggplot() +

...
Use energy detection to get the detection range.
...
Here we padded the detection to ensure the duration of the signal is a multiply of 3 seconds (3, 6, 9, 12, or 15 seconds), as the 3 seconds segments are the standard BirdNET segment duration.
...
Plot the original detection and the padded detection to see the difference.
